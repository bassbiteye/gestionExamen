                    ...
                    <div class="nk-content-inner">
                        <div class="nk-content-body">
                            <div id="app">
                                ...
                                <div id="message" class="alert alert-primary">examen est débloqué avec success</div>
                            </c:if>

                                <c:if test="${etat=='2'}">
                                    <div id="message" class="alert alert-danger">examen est bloqué avec success</div>
                                </c:if>
                                                        ...
                                                        <div class="row g-4">
                                                            <div class="col-lg-6">
                                                                <div class="form-group"><label for="nomE"
                                                                                               class="form-label">nom</label>
                                                                    <div class="form-control-wrap"><input
                                                                            type="text" name="nomE" id="nomE" value="${examenUpdate.nom}"
                                                                            class="form-control"> <!----></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
